...
# Purpose:
#  This version of the log observer assumes that various systems have
#  transferred their logs to the local machine somehow (e.g. syslogd).
#  Thus we use the file name for the hostname and use an underscore for the
#  file name.  
#
...
class LogObserver(object):
    ...
    def _send_line_to_server(self, server, log_name, log_line): 
        ...
        if uuid:
            ...
            host = log_name.split('/')[-1] 
            host = host.replace('.log','')
